...
import { actualizarProducto, crearProducto } from '@/app/database/acciones';
...
export default function EditarProducto({
    ...
    try {
      const response = await actualizarProducto(producto.ID, formData);
      if (response.error) {
      ...
      setErrorMessage('Error al editar el Producto. "TODOS LOS CAMPOS SON REQUERIDOS", inténtelo de nuevo.');
    }
  };
    ...
    return (
        <div className="max-w-6xl p-6 mx-auto rounded-md  bg-cyan-900 mt-7">
            <h1 className="text-4xl uppercase font-bold text-white from-current mb-8 text-center mt-5">Editar producto</h1>
            <section >
                        ...
                        <div className='mt-10'>
                            ...
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div className="space-y-1 text-center items-center">
                                    ...
                                    <p className="text-red-500 mt-4">LA IMAGEN DEBE ACTUALIZARSE</p>
