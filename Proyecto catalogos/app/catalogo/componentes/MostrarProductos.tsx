    ...
    <div className="p-6 container mx-auto rounded-xl">
      ...
      <div className="p-5 flex flex-wrap justify-center">
        {productos.map((data) => {
          ...
          return (
            <div key={data.ID} className={`flex-shrink-0 m-3 h-auto relative overflow-hidden ${colorClass} rounded-lg hover:shadow-xl transform transition duration-500 hover:scale-105`}>
              <svg className="absolute bottom-0  mb-16" viewBox="0 0 375 283" fill="none">
