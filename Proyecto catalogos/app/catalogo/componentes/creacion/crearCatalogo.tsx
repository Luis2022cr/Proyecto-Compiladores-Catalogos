...
import { crearCatalogo } from '@/app/database/acciones';
import { useState } from 'react';

export default function CrearCatalogo({ categorias }: { categorias: Categoria[] }) {
  ...
  const EnviarData = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        const response = await crearCatalogo(formData);
