...
export default async function MostrarCatalogosCatId({
  catalogo,
}: {
  catalogo: Catalogo[];
}) {
    ...
    <div className="min-h-screen flex justify-center items-center ">
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {catalogo.map((data) => (
            <div key={data.ID} className="bg-cyan-900 text-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105 border-4 border-cyan-400">
              <Image
